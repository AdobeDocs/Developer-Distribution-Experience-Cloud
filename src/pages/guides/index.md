...
Use Developer Distribution to publish and distribute App Builder Apps, Server-to-server integrations and Catalog listings to extend Adobe Experience Cloud products. Once submitted, these listings will be approved by Adobe reviewers before being published on the Adobe Exchange Marketplace.
...
Developers must join the [Digital Experience Partner Program](https://partners.adobe.com/digitalexperience/) in order to publish Experience Cloud listings. After joining, developers can request product sandboxes and are assigned an org/account to manage listings. The first registered partner user for an enterprise developer can enable other users to access Developer Distribution and Developer Console by assigning an admin role for additional Adobe ID user credentials in [Admin Console Login](https://adminconsole.adobe.com/). This way, anyone associated with their org/account will be able to manage projects and listings. Partner program members who still get an error attempting to use Developer Distribution should contact [Partner Support](https://partners.adobe.com/digitalexperience/m/forms/case).
